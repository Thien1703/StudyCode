...
export default function HightScores() {
    const dummyData = [
        { id: 1, img: img, top: 4, name: 'John Doe', score: 0.03 },
        { id: 2, img: img, top: 5, name: 'Jane Smith', score: 0.022 },
        { id: 3, img: img, top: 6, name: 'Alice Johnson', score: 0.029 },
    ...
    const RenderPlayer = React.memo(({ img, top, name, score }) => (
        <RowComponent style={styles.top5}>
            ...
            <View style={styles.rowC}>
                ...
                <MoneySend size="16" variant="Bold" color={
        ...
        <SafeAreaView style={styles.home}>
            <Container style={[styles.container]}>
                ...
                <View style={{ marginTop: 30 }}>
                    <Text style={[styles.txtDot, { fontSize: 25, alignSelf: 'center' }]}>SOLONA REWARD</Text>
                    <View style={{ width: wp(95), flexDirection: 'row', justifyContent: 'space-around' }}>
                        <View style={[styles.circle, styles.top2]} >
                            ...
                            <View style={{ marginTop: 25, flexDirection: 'column', alignItems: 'center' }}>
                                ...
                                <View style={[styles.rowC]}>
                                    <Text style={[styles.txtName, { marginRight: 10 }]}>0.2</Text>
                        ...
                        <View style={styles.circle} >
                            ...
                            <View style={{ marginTop: 25, flexDirection: 'column', alignItems: 'center' }}>
                                <Text style={[styles.point]}>John Doe</Text>
                                <View style={[styles.rowC]}>
                                    <Text style={[styles.txtName, { marginRight: 10 }]}>0.3</Text>
                                    <MoneySend size="16" variant="Bold" color="#FFD912" />
                                </View>
                            </View>
                        </View>
                        <View style={[styles.circle, styles.top2]} >
                            ...
                            <View style={{ marginTop: 25, flexDirection: 'column', alignItems: 'center' }}>
                                <Text style={[styles.point]}>John Doe</Text>
                                <View style={[styles.rowC]}>
                                    <Text style={[styles.txtName, { marginRight: 10 }]}>0.1</Text>
                                    <MoneySend size="16" variant="Bold" color="#FFD912" />
                                </View>
                            </View>
                        </View>
...
const styles = StyleSheet.create({
    ...
    top5: {
        ...
        width: wp(95), backgroundColor: Color.colorInput,
        borderRadius: 20,
        marginBottom: hp(2),
        elevation: 4,
        ...(Platform.OS !== 'android' && {
